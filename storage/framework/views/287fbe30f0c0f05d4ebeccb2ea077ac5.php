...
<div class="sidenav-menu">
    <!-- Brand Logo -->
    <a class="logo" href="<?php echo e(route('second', ['dashboard', 'index'])); ?>">
    ...
    <div class="scrollbar" data-simplebar="">
        ...
        <div class="sidenav-user">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <a class="link-reset" href="<?php echo e(route('second', ['users', 'profile'])); ?>">
                ...
                <div>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <!-- My Profile -->
                        <a class="dropdown-item" href="<?php echo e(route('second', ['users', 'profile'])); ?>">
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarDashboards">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['dashboard', 'index'])); ?>">
                                <span class="menu-text" data-lang="dashboard-one">Dashboard 1</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['dashboard', 'index-2'])); ?>">
            ...
            <li class="side-nav-item">
                <a class="side-nav-link" href="<?php echo e(route('any', 'landing')); ?>" target="_blank">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEcommerce">
                    <ul class="sub-menu">
                                ...
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['ecommerce', 'products'])); ?>">
                                            <span class="menu-text" data-lang="eco-pro-listing">Listing</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['ecommerce', 'products-grid'])); ?>">
                                            <span class="menu-text" data-lang="eco-pro-grid">Products Grid</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['ecommerce', 'product-details'])); ?>">
                                            <span class="menu-text" data-lang="eco-pro-details">Product Details</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['ecommerce', 'add-product'])); ?>">
                        ...
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ecommerce', 'categories'])); ?>">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarOrders">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['ecommerce', 'orders'])); ?>">
                                            <span class="menu-text" data-lang="eco-orders-list">Orders</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['ecommerce', 'order-details'])); ?>">
                        ...
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ecommerce', 'customers'])); ?>">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarSellers">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['ecommerce', 'sellers'])); ?>">
                                            <span class="menu-text" data-lang="eco-sellers-list">Sellers</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['ecommerce', 'seller-details'])); ?>">
                        ...
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ecommerce', 'reviews'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEmail">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['email', 'email'])); ?>">
                                <span class="menu-text" data-lang="email-inbox">Inbox</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['email', 'details'])); ?>">
                                <span class="menu-text" data-lang="email-details">Details</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['email', 'compose'])); ?>">
                                <span class="menu-text" data-lang="email-compose">Compose</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['email', 'templates'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarCRM">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'contacts'])); ?>">
                                <span class="menu-text" data-lang="crm-contacts">Contacts</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'opportunities'])); ?>">
                                <span class="menu-text" data-lang="crm-opportunities">Opportunities</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'deals'])); ?>">
                                <span class="menu-text" data-lang="crm-deals">Deals</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'leads'])); ?>">
                                <span class="menu-text" data-lang="crm-leads">Leads</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'pipeline'])); ?>">
                                <span class="menu-text" data-lang="crm-pipeline">Pipeline</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'campaign'])); ?>">
                                <span class="menu-text" data-lang="crm-campaign">Campaign</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'proposals'])); ?>">
                                <span class="menu-text" data-lang="crm-proposals">Proposals</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'estimations'])); ?>">
                                <span class="menu-text" data-lang="crm-estimations">Estimations</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'customers'])); ?>">
                                <span class="menu-text" data-lang="crm-customers">Customers</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['crm', 'activities'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarUsers">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['users', 'contacts'])); ?>">
                                <span class="menu-text" data-lang="contacts">Contacts</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['users', 'profile'])); ?>">
                                <span class="menu-text" data-lang="profile">Profile</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['users', 'roles'])); ?>">
                                <span class="menu-text" data-lang="roles">Roles</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['users', 'role-details'])); ?>">
                                <span class="menu-text" data-lang="role-details">Role Details</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['users', 'permissions'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarInvoice">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['invoice', 'invoices'])); ?>">
                                <span class="menu-text" data-lang="invoices">Invoices</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['invoice', 'details'])); ?>">
                                <span class="menu-text" data-lang="invoice-details">Single Invoice</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['invoice', 'create'])); ?>">
            ...
            <li class="side-nav-item">
                <a class="side-nav-link" href="<?php echo e(route('second', ['apps', 'social-feed'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarTickets">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ticket', 'list'])); ?>">
                                <span class="menu-text" data-lang="tickets">Tickets List</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ticket', 'details'])); ?>">
                                <span class="menu-text" data-lang="ticket-details">Ticket Details</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ticket', 'create'])); ?>">
            ...
            <li class="side-nav-item">
                <a class="side-nav-link" href="<?php echo e(route('second', ['apps', 'api-keys'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarPages">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['pages', 'faq'])); ?>">
                                <span class="menu-text" data-lang="pages-faq">FAQ</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['pages', 'pricing'])); ?>">
                                <span class="menu-text" data-lang="pages-pricing">Pricing</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['pages', 'empty'])); ?>">
                                <span class="menu-text" data-lang="pages-empty">Empty Page</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['pages', 'timeline'])); ?>">
                                <span class="menu-text" data-lang="pages-timeline">Timeline</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['pages', 'sitemap'])); ?>">
                                <span class="menu-text" data-lang="pages-sitemap">Sitemap</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['pages', 'search-results'])); ?>">
                                <span class="menu-text" data-lang="pages-search-results">Search Results</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['pages', 'coming-soon'])); ?>">
                                <span class="menu-text" data-lang="pages-coming-soon">Coming Soon</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['pages', 'terms-conditions'])); ?>">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarTwoAuth">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a class="side-nav-link" href="<?php echo e(route('second', ['auth', '2-sign-in'])); ?>">
                                            <span class="menu-text" data-lang="auth-2-sign-in">Sign In</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link" href="<?php echo e(route('second', ['auth', '2-sign-up'])); ?>">
                                            <span class="menu-text" data-lang="auth-2-sign-up">Sign Up</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['auth', '2-reset-pass'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['auth', '2-login-pin'])); ?>">
                                            <span class="menu-text" data-lang="auth-2-login-pin">Login with PIN</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['auth', '2-delete-account'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarPagesError">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['error', '400'])); ?>">
                                <span class="menu-text" data-lang="error-400">400 Bad Request</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['error', '401'])); ?>">
                                <span class="menu-text" data-lang="error-401">401 Unauthorized</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['error', '403'])); ?>">
                                <span class="menu-text" data-lang="error-403">403 Forbidden</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['error', '404'])); ?>">
                                <span class="menu-text" data-lang="error-404">404 Not Found</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['error', '408'])); ?>">
                                <span class="menu-text" data-lang="error-408">408 Request Timeout</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['error', '500'])); ?>">
                                <span class="menu-text" data-lang="error-500">500 Internal Server</span>
                            </a>
                        </li>
                        <li class="side-nav-item">  
                            <a class="side-nav-link" href="<?php echo e(route('second', ['error', 'maintenance'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarLayouts">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['layouts-eg', 'scrollable'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="layouts-scrollable">Scrollable</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['layouts-eg', 'compact'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="layouts-compact">Compact</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['layouts-eg', 'boxed'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="layouts-boxed">Boxed</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['layouts-eg', 'horizontal'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="layouts-horizontal">Horizontal</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['layouts-eg', 'preloader'])); ?>"
                                target="_blank">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarSidebars">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'dark'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-dark">Dark Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'gradient'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-gradient">Gradient Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'gray'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-gray">Gray Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'image'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-image">Image Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'compact'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-compact">Compact Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'icon-view'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-icon-view">Icon View Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'on-hover'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-on-hover">On Hover Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'on-hover-active'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-on-hover-active">On Hover Active</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'offcanvas'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-offcanvas">Offcanvas Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'no-icons'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="sidebar-no-icons">No Icons with Lines</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['sidebar', 'with-lines'])); ?>"
                                target="_blank">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarTopbars">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['topbar', 'light'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="topbar-light">Light Topbar</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['topbar', 'gray'])); ?>"
                                target="_blank">
                                <span class="menu-text" data-lang="topbar-gray">Gray Topbar</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['topbar', 'gradient'])); ?>"
                                target="_blank">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarBaseUI">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'buttons'])); ?>">
                                <span class="menu-text" data-lang="ui-buttons">Buttons</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'images'])); ?>">
                                <span class="menu-text" data-lang="ui-images">Images</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'accordions'])); ?>">
                                <span class="menu-text" data-lang="ui-accordions">Accordions</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'alerts'])); ?>">
                                <span class="menu-text" data-lang="ui-alerts">Alerts</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'badges'])); ?>">
                                <span class="menu-text" data-lang="ui-badges">Badges</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'breadcrumb'])); ?>">
                                <span class="menu-text" data-lang="ui-breadcrumb">Breadcrumb</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'cards'])); ?>">
                                <span class="menu-text" data-lang="ui-cards">Cards</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'carousel'])); ?>">
                                <span class="menu-text" data-lang="ui-carousel">Carousel</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'collapse'])); ?>">
                                <span class="menu-text" data-lang="ui-collapse">Collapse</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'colors'])); ?>">
                                <span class="menu-text" data-lang="ui-colors">Colors</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'dropdowns'])); ?>">
                                <span class="menu-text" data-lang="ui-dropdowns">Dropdowns</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'videos'])); ?>">
                                <span class="menu-text" data-lang="ui-videos">Videos</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'grid'])); ?>">
                                <span class="menu-text" data-lang="ui-grid">Grid Options</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'links'])); ?>">
                                <span class="menu-text" data-lang="ui-links">Links</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'list-group'])); ?>">
                                <span class="menu-text" data-lang="ui-list-group">List Group</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'modals'])); ?>">
                                <span class="menu-text" data-lang="ui-modals">Modals</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'notifications'])); ?>">
                                <span class="menu-text" data-lang="ui-notifications">Notifications</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'offcanvas'])); ?>">
                                <span class="menu-text" data-lang="ui-offcanvas">Offcanvas</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'placeholders'])); ?>">
                                <span class="menu-text" data-lang="ui-placeholders">Placeholders</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'pagination'])); ?>">
                                <span class="menu-text" data-lang="ui-pagination">Pagination</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'popovers'])); ?>">
                                <span class="menu-text" data-lang="ui-popovers">Popovers</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'progress'])); ?>">
                                <span class="menu-text" data-lang="ui-progress">Progress</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'scrollspy'])); ?>">
                                <span class="menu-text" data-lang="ui-scrollspy">Scrollspy</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'spinners'])); ?>">
                                <span class="menu-text" data-lang="ui-spinners">Spinners</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'tabs'])); ?>">
                                <span class="menu-text" data-lang="ui-tabs">Tabs</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'tooltips'])); ?>">
                                <span class="menu-text" data-lang="ui-tooltips">Tooltips</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'typography'])); ?>">
                                <span class="menu-text" data-lang="ui-typography">Typography</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['ui', 'utilities'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarMiscellaneous">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['misc', 'sortable'])); ?>">
                                <span class="menu-text" data-lang="misc-sortable">Sortable List</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['misc', 'pdf-viewer'])); ?>">
                                <span class="menu-text" data-lang="misc-pdf-viewer">PDF Viewer</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['misc', 'i18'])); ?>">
                                <span class="menu-text" data-lang="misc-i18">i18 Support</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['misc', 'sweet-alerts'])); ?>">
                                <span class="menu-text" data-lang="misc-sweet-alerts">Sweet Alerts</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['misc', 'pass-meter'])); ?>">
                                <span class="menu-text" data-lang="misc-pass-meter">Password Meter</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['misc', 'clipboard'])); ?>">
                                <span class="menu-text" data-lang="misc-clipboard">Clipboard</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['misc', 'tree-view'])); ?>">
                                <span class="menu-text" data-lang="misc-tree-view">Tree View</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['misc', 'tour'])); ?>">
            ...
            <li class="side-nav-item">
                <a class="side-nav-link" href="<?php echo e(route('any', 'widgets')); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarCharts">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarApexCharts">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-area'])); ?>">
                                            <span class="menu-text" data-lang="charts-apex-area">Area</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-bar'])); ?>">
                                            <span class="menu-text" data-lang="charts-apex-bar">Bar</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-bubble'])); ?>">
                                            <span class="menu-text" data-lang="charts-apex-bubble">Bubble</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-candlestick'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-scatter'])); ?>">
                                            <span class="menu-text" data-lang="charts-apex-scatter">Scatter</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-polar-area'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-sparklines'])); ?>">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-range'])); ?>">
                                            <span class="menu-text" data-lang="charts-apex-range">Range</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-funnel'])); ?>">
                                            <span class="menu-text" data-lang="charts-apex-funnel">Funnel</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['charts', 'apex-slope'])); ?>">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarChartJs">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('third', ['charts', 'chartjs', 'area'])); ?>">
                                            <span class="menu-text" data-lang="chartjs-area">Area</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link" href="<?php echo e(route('third', ['charts', 'chartjs', 'bar'])); ?>">
                                            <span class="menu-text" data-lang="chartjs-bar">Bar</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('third', ['charts', 'chartjs', 'line'])); ?>">
                                            <span class="menu-text" data-lang="chartjs-line">Line</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('third', ['charts', 'chartjs', 'other'])); ?>">
                        ...
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['charts', 'apextree'])); ?>">
                                <span class="menu-text" data-lang="charts-apextree">Apex Tree</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['charts', 'apexsankey'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarForms">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'elements'])); ?>">
                                <span class="menu-text" data-lang="form-elements">Basic Elements</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'pickers'])); ?>">
                                <span class="menu-text" data-lang="form-pickers">Pickers</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'select'])); ?>">
                                <span class="menu-text" data-lang="form-select">Select</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'validation'])); ?>">
                                <span class="menu-text" data-lang="form-validation">Validation</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'wizard'])); ?>">
                                <span class="menu-text" data-lang="form-wizard">Wizard</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'fileuploads'])); ?>">
                                <span class="menu-text" data-lang="form-fileuploads">File Uploads</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'text-editors'])); ?>">
                                <span class="menu-text" data-lang="form-text-editors">Text Editors</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'range-slider'])); ?>">
                                <span class="menu-text" data-lang="form-range-slider">Range Slider</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'layouts'])); ?>">
                                <span class="menu-text" data-lang="form-layouts">Layouts</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['form', 'other-plugins'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarTables">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['tables', 'static'])); ?>">
                                <span class="menu-text" data-lang="tables-static">Static Tables</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['tables', 'custom'])); ?>">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarDataTables">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-basic'])); ?>">
                                            <span class="menu-text" data-lang="tables-datatables-basic">Basic</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-export-data'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-select'])); ?>">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-ajax'])); ?>">
                                            <span class="menu-text" data-lang="tables-datatables-ajax">Ajax</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-javascript'])); ?>">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-rendering'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-scroll'])); ?>">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-fixed-columns'])); ?>">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-columns'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-child-rows'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-column-searching'])); ?>">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-range-search'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-fixed-header'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-add-rows'])); ?>">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="<?php echo e(route('second', ['tables', 'datatables-checkbox-select'])); ?>">
                                            <span class="menu-text"
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarIcons">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['icons', 'tabler'])); ?>">
                                <span class="menu-text" data-lang="icons-tabler">Tabler</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['icons', 'lucide'])); ?>">
                                <span class="menu-text" data-lang="icons-lucide">Lucide</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['icons', 'flags'])); ?>">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarMaps">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['maps', 'vector'])); ?>">
                                <span class="menu-text" data-lang="maps-vector">Vector Maps</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="<?php echo e(route('second', ['maps', 'leaflet'])); ?>">
...
<!-- Sidenav Menu End -->
<?php /**PATH D:\final-project-smstr1\resources\views\layouts\partials\sidenav.blade.php ENDPATH**/ ?>