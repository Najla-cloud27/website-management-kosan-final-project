                    ...
                    <div class="tour-wrapper">
                        <div class="activities-details-wrapper">
                            ...
                            <div class="activities-list-item">
                                ...
                                <?php if(is_array($roomFasilitas) && count($roomFasilitas) > 0): ?>
                                <div class="activities-item">
                                    <ul class="activities-list">
                                        <?php $__currentLoopData = $firstColumn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                    ...
                                    <ul class="activities-list">
                                        <?php $__currentLoopData = $secondColumn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <i class="fa-solid <?php echo e($iconMap[$facility] ?? 'fa-check'); ?>"></i>
                                            <?php echo e($facility); ?>
