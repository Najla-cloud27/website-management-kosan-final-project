...
<div class="page-title-head d-flex align-items-center mb-4">
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            ...
            <!--[if BLOCK]><![endif]--><?php if(isset($breadcrumbs) && is_array($breadcrumbs)): ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!--[if BLOCK]><![endif]--><?php if(isset($breadcrumb['url']) && !$loop->last): ?>
                        <li class="breadcrumb-item">
            ...
            <?php else: ?>
                <!--[if BLOCK]><![endif]--><?php if(isset($subtitle)): ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH D:\file-belajar-website-IDN\final-project-smstr1\resources\views/layouts/partials/page-title.blade.php ENDPATH**/ ?>