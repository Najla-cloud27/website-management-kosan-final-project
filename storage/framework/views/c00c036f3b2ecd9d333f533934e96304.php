...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php elseif($editingId): ?>
                            ...
                            <?php if($room && $room->main_image_url): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-2">
                            <?php $__currentLoopData = $availableFasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>
                        <?php if($additional_images): ?>
                            <div class="d-flex gap-2 mt-2">
                                <?php $__currentLoopData = $additional_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($editingId): ?>
                        ...
                        <?php if($room && $room->images->count() > 0): ?>
                        <div class="col-12">
...
<img src="<?php echo e(asset('storage/' . $room->main_image_url)); ?>">
                            ...
                            <td>
                                <?php if($room->fasilitas && is_array($room->fasilitas) && count($room->fasilitas) > 0): ?>
                                    <small><?php echo e(implode(', ', array_slice($room->fasilitas, 0, 3))); ?></small>
                                    <?php if(count($room->fasilitas) > 3): ?>
