...
<?php $__env->startSection('title', 'Hubungi Kami - Kosan DiriQ'); ?>
...
<section class="contact-section section-padding fix section-bg bg-cover" style="background-image: url('<?php echo e(asset('travo/img/contact/bg.png')); ?>');">
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay=".2s">
                <div class="contact-wrapper">
                    ...
                    <div class="contact-thumb">
                        ...
                        <h4>
                            <img src="<?php echo e(asset('travo/img/icon/phone.svg')); ?>" alt="phone"> 
                            +62 812-3456-7890
                        </h4>
                    </div>
                ...
                <div class="contact-form style-2">
                    ...
                    <form action="<?php echo e(route('contact.submit')); ?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-clt">
                                    <input type="text" name="name" id="name" placeholder="Nama Lengkap *" value="<?php echo e(old('name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-6">
                                <div class="form-clt">
                                    <input type="tel" name="phone" id="phone" placeholder="No. Telepon *" value="<?php echo e(old('phone')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="form-clt">
                                    <input type="email" name="email" id="email" placeholder="Alamat Email *" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="form-clt">
                                    <input type="text" name="subject" id="subject" placeholder="Subjek" value="<?php echo e(old('subject')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="form-clt">
                                    <textarea name="message" id="message" placeholder="Tulis pesan Anda *" required><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\final-project-smstr1\resources\views\public\contact.blade.php ENDPATH**/ ?>