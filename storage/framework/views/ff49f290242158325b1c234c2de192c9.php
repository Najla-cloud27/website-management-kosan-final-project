...
<?php $__env->startSection('title', 'Tentang Kami - Kosan DiriQ'); ?>

<?php $__env->startSection('content'); ?>

<!-- Breadcrumb Section -->
<div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('<?php echo e(asset('travo/img/breadcrumb/01.jpg')); ?>');">
    <div class="container">
                    ...
                    <div class="about-content">
                        ...
                        <div class="about-button wow fadeInUp" data-wow-delay=".7s">
                            <a href="<?php echo e(route('rooms.index')); ?>" class="theme-btn">
                                ...
                                <img src="<?php echo e(asset('travo/img/icon/white-arrow.svg')); ?>" alt="arrow">
                            </a>
                        </div>
                    </div>
                </div>
...
<section class="achievement-section section-padding fix pb-0">
    <div class="shape-top">
        <img src="<?php echo e(asset('travo/img/shape/random-top.png')); ?>" alt="shape">
    </div>
    <div class="shape-bottom">
        <img src="<?php echo e(asset('travo/img/shape/random-bottom.png')); ?>" alt="shape">
    </div>
    <div class="container">
        <div class="section-title-area">
            ...
            <div class="achievement-button wow fadeInUp" data-wow-delay=".7s">
                <a href="<?php echo e(route('contact')); ?>" class="theme-btn">
                    Hubungi Kami
                    <img src="<?php echo e(asset('travo/img/icon/white-arrow.svg')); ?>" alt="arrow">
                </a>
            </div>
...
<section class="choose-us-section section-padding fix section-bg">
    <div class="left-shape float-bob-x">
        <img src="<?php echo e(asset('travo/img/shape/plane-3.png')); ?>" alt="shape">
    </div>
    <div class="dot-shape">
        <img src="<?php echo e(asset('travo/img/shape/dot-1.png')); ?>" alt="shape">
    </div>
    <div class="right-shape">
        <img src="<?php echo e(asset('travo/img/choose-us/shape1.png')); ?>" alt="shape">
    </div>
    <div class="container">
                    ...
                    <div class="choose-us-content">
                        ...
                        <div class="choose-us-area">
                            <div class="line-image">
                                <img src="<?php echo e(asset('travo/img/shape/line-shape.png')); ?>" alt="line">
                            </div>
        ...
        <div class="row g-4">
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                <div class="service-card-items">
                    ...
                    <div class="content">
                        <h4>
                            <a href="<?php echo e(route('rooms.index')); ?>">Pelayanan Prima</a>
                        </h4>
                        <p>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                <div class="service-card-items">
                    ...
                    <div class="content">
                        <h4>
                            <a href="<?php echo e(route('rooms.index')); ?>">Kenyamanan Seperti Rumah</a>
                        </h4>
                        <p>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                <div class="service-card-items">
                    ...
                    <div class="content">
                        <h4>
                            <a href="<?php echo e(route('rooms.index')); ?>">Transparansi & Kepercayaan</a>
                        </h4>
                        <p>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                <div class="service-card-items">
                    ...
                    <div class="content">
                        <h4>
                            <a href="<?php echo e(route('rooms.index')); ?>">Lingkungan Bersih & Sehat</a>
                        </h4>
                        <p>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="1s">
                <div class="service-card-items">
                    ...
                    <div class="content">
                        <h4>
                            <a href="<?php echo e(route('rooms.index')); ?>">Komunitas Positif</a>
                        </h4>
                        <p>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="1.2s">
                <div class="service-card-items">
                    ...
                    <div class="content">
                        <h4>
                            <a href="<?php echo e(route('rooms.index')); ?>">Inovasi Berkelanjutan</a>
                        </h4>
                        <p>
...
<!-- CTA Section -->
<section class="cta-section cta-2 bg-cover" style="background-image: url('<?php echo e(asset('travo/img/cta-bg.jpg')); ?>');">
    <div class="container">
            ...
            <div class="row g-4 align-items-center justify-content-between">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="cta-button text-lg-end wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="theme-btn" style="background: #fff; color: #2196F3; margin-left: 15px;">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\final-project-smstr1\resources\views\public\about.blade.php ENDPATH**/ ?>