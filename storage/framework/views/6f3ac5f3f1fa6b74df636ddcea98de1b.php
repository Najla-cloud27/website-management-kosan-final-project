    ...
    <div class="container-fluid topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="logo-topbar">
                <!-- Logo light -->
                <a class="logo-light" href="<?php echo e(route('tenant.dashboard')); ?>">
                    <span class="logo-lg">
                ...
                <!-- Logo Dark -->
                <a class="logo-dark" href="<?php echo e(route('tenant.dashboard')); ?>">
                    <span class="logo-lg">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3386232927-0', $__slots ?? [], get_defined_vars());
            ...
            <div class="topbar-item nav-user">
                <div class="dropdown">
                    <a aria-expanded="false" aria-haspopup="false"
                        ...
                        <img alt="user-image" class="rounded-circle me-lg-2 d-flex" src="/images/users/user-2.jpg"
                            width="32" />
...
<!-- Topbar End -->
<?php /**PATH D:\final-project-smstr1\resources\views/layouts/partials/topbar-tenant.blade.php ENDPATH**/ ?>