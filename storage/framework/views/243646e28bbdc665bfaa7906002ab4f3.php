<div>
        ...
        <div class="card-body">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="mb-3 pb-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($announcement->image_url): ?>
                        <div class="mt-2">
    ...
    <!-- Recent Bills -->
    <!--[if BLOCK]><![endif]--><?php if($recentBills->count() > 0): ?>
        <div class="card mb-4">
            <div class="card-header">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentBills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
    ...
    <!-- Active Bookings -->
    <!--[if BLOCK]><![endif]--><?php if($activeBookings->count() > 0): ?>
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-house-check"></i> Booking Aktif</h5>
            </div>
            <div class="card-body">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $activeBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\final-project-smstr1\resources\views/livewire/tenant/dashboard.blade.php ENDPATH**/ ?>