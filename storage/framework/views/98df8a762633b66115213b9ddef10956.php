                        ...
                        <table class="table table-hover table-centered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($booking->status === 'pembayaran_tertunda'): ?>
                                    ...
                                    <td>
                                        <?php if(in_array($booking->status, ['pembayaran_tertunda', 'dikonfirmasi'])): ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__errorArgs = ['selectedRoomId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH D:\final-project-smstr1\resources\views\livewire\tenant\booking\my-bookings.blade.php ENDPATH**/ ?>