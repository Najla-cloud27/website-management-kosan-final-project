    ...
    <div class="container-fluid topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="logo-topbar">
                <!-- Logo light -->
                <a class="logo-light" href="<?php echo e(route('second', ['dashboard', 'index'])); ?>">
                    <span class="logo-lg">
                ...
                <!-- Logo Dark -->
                <a class="logo-dark" href="<?php echo e(route('second', ['dashboard', 'index'])); ?>">
                    <span class="logo-lg">
...
<!-- Topbar End -->
<?php /**PATH D:\final-project-smstr1\resources\views\layouts\partials\topbar.blade.php ENDPATH**/ ?>