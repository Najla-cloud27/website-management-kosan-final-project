...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__errorArgs = ['selectedUserId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($activeTab === 'pending_proofs'): ?>
        <div class="row">
            <?php $__empty_1 = true; $__currentLoopData = $pendingProofs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <?php if($proof->payment_proof_url): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\final-project-smstr1\resources\views\livewire\admin\billing\manage-billing.blade.php ENDPATH**/ ?>