    ...
    <nav class="navbar navbar-expand-lg">
        <nav class="container-fluid">
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('second', ['dashboard', 'index'])); ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div aria-labelledby="topnav-layouts" class="dropdown-menu">
                            <a class="dropdown-item" href="<?php echo e(route('second', ['dashboard', 'index'])); ?>">Vertical</a>
                            <a class="dropdown-item"
                                href="<?php echo e(route('second', ['layouts', 'horizontal'])); ?>">Horizontal</a>
                        </div>
                    </li>
                    <li class="nav-item">
...
<!-- Horizontal Menu End -->
<?php /**PATH D:\final-project-smstr1\resources\views\layouts\partials\horizontal-nav.blade.php ENDPATH**/ ?>