                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($bill->paymentProofs->count() > 0): ?>
                                    <div class="mt-2">
                                        <small><strong>Bukti Pembayaran:</strong></small>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $bill->paymentProofs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex align-items-center gap-2 mt-1">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($proof->admin_notes): ?>
                            ...
                            <div class="col-md-4 text-end">
                                <!--[if BLOCK]><![endif]--><?php if($bill->status === 'belum_dibayar' || ($bill->status === 'verifikasi_tertunda' && $bill->paymentProofs->where('status', 'rejected')->count() > 0)): ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['proofFile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($uploadingForBillId == $bill->id && $proofFile): ?>
                                <div class="mt-2">
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\final-project-smstr1\resources\views/livewire/tenant/billing/history.blade.php ENDPATH**/ ?>