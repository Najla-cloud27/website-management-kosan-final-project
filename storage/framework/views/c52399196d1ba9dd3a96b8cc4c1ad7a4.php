    ...
    <div class="scrollbar" data-simplebar="">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <a class="link-reset" href="javascript:void(0);">
                        ...
                        <span class="fs-12 fw-semibold">Pemilik Kosan</span>
                    </a>
                </div>
                <div>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a class="side-nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" 
            ...
            <!-- Manajemen Kamar -->
            <li class="side-nav-item">
                <a class="side-nav-link <?php echo e(request()->routeIs('admin.rooms.*') ? 'active' : ''); ?>" 
                   href="<?php echo e(route('admin.rooms.manage')); ?>">
            ...
            <!-- Manajemen Booking -->
            <li class="side-nav-item">
                <a class="side-nav-link <?php echo e(request()->routeIs('admin.bookings.*') ? 'active' : ''); ?>" 
                   href="<?php echo e(route('admin.bookings.manage')); ?>">
                    <span class="menu-icon"><i data-lucide="calendar-check"></i></span>
                    <span class="menu-text">Manajemen Booking</span>
                </a>
            </li>

            <!-- Manajemen Tagihan -->
            <li class="side-nav-item">
                <a class="side-nav-link <?php echo e(request()->routeIs('admin.billing.*') ? 'active' : ''); ?>" 
                   href="<?php echo e(route('admin.billing.manage')); ?>">
            ...
            <!-- Manajemen Keluhan -->
            <li class="side-nav-item">
                <a class="side-nav-link <?php echo e(request()->routeIs('admin.complaints.*') ? 'active' : ''); ?>" 
                   href="<?php echo e(route('admin.complaints.manage')); ?>">
                    <span class="menu-icon"><i data-lucide="message-circle-warning"></i></span>
                    <span class="menu-text">Manajemen Keluhan</span>
                </a>
            </li>

            <!-- Pengumuman -->
            <li class="side-nav-item">
                <a class="side-nav-link <?php echo e(request()->routeIs('admin.announcements.*') ? 'active' : ''); ?>" 
                   href="<?php echo e(route('admin.announcements.manage')); ?>">
            ...
            <li class="side-nav-item">
                <a class="side-nav-link" href="<?php echo e(route('rooms.index')); ?>" target="_blank">
                    ...
                    <span class="menu-text">Lihat Katalog Publik</span>
                </a>
            </li>
        </ul>
    </div>
...
<!-- Sidenav Menu End -->
<?php /**PATH D:\file-belajar-website-IDN\final-project-smstr1\resources\views/layouts/partials/sidenav-admin.blade.php ENDPATH**/ ?>