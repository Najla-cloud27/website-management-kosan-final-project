            ...
            <div class="row">
                <div class="page-heading">
                    ...
                    <ul class="breadcrumb-list">
                        ...
                        <li><a href="<?php echo e(route('rooms.index')); ?>">Kamar</a></li>
                        <li><i class="fa-solid fa-chevrons-right"></i></li>
                        <li class="active"><?php echo e($room->name); ?></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="tour-wrapper">
                        <div class="activities-details-wrapper">
                            ...
                            <div class="room-image-container">
                                <!--[if BLOCK]><![endif]--><?php if($room->main_image_url): ?>
                                    ...
                                    <div class="single-image">
                                        <img src="<?php echo e(asset('storage/' . $room->main_image_url)); ?>" 
                                ...
                                <div class="content">
                                    <h6>
                                        ...
                                        <?php else: ?>
                                            <span class="badge bg-secondary"><?php echo e(ucwords(str_replace('_', ' ', $room->status))); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </h6>
                                    <h2><?php echo e($room->name); ?></h2>
                                    <p class="mb-3">
                                        <?php echo e($room->description ?? 'Kamar nyaman dengan fasilitas lengkap, cocok untuk mahasiswa atau pekerja. Lingkungan aman, tenang, dan strategis. Dilengkapi dengan berbagai fasilitas pendukung untuk kenyamanan Anda.'); ?>
                            ...
                            <div class="activities-list-item">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(is_array($roomFasilitas) && count($roomFasilitas) > 0): ?>
                                <div class="activities-item">
                                    <ul class="activities-list">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $firstColumn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <i class="fa-solid <?php echo e($iconMap[$facility] ?? 'fa-check'); ?>"></i>
                                            <?php echo e($facility); ?>
                                    ...
                                    <ul class="activities-list">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $secondColumn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <i class="fa-solid <?php echo e($iconMap[$facility] ?? 'fa-check'); ?>"></i>
                                            <?php echo e($facility); ?>
                                ...
                                <div class="activities-box-area">
                                    <div class="activities-box-item">
                                        ...
                                        <div class="content">
                                            ...
                                            <h6><?php echo e($room->size ?? '3x4 meter'); ?></h6>
                                        </div>
                                    </div>
                                    <div class="activities-box-item">
                                        <div class="icon">
                                        ...
                                        <div class="content">
                                            ...
                                            <h6>Rp <?php echo e(number_format($room->price, 0, ',', '.')); ?></h6>
                                        </div>
                                    </div>
                                    <div class="activities-box-item">
                                        <div class="icon">
                                    ...
                                    <div class="activities-box-item">
                                        ...
                                        <div class="content">
                                            <span>Status</span>
                                            <h6><?php echo e(ucfirst($room->status)); ?></h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="booking-sidebar">
                                ...
                                <div class="booking-items">
                                    <div class="price-area">
                                        <h3>Rp <?php echo e(number_format($room->price, 0, ',', '.')); ?></h3>
                                        <span>/Bulan</span>
                                    </div>
...
<div class="booking-modal-backdrop" wire:click="closeModal">
    <div class="booking-modal" wire:click.stop>
        <div class="booking-modal-header <?php echo e($modalType); ?>">
            <h5 class="mb-0" style="color: white;">
                <!--[if BLOCK]><![endif]--><?php if($modalType === 'success'): ?>
                    <i class="fa-solid fa-check-circle me-2"></i>
                <?php else: ?>
                    <i class="fa-solid fa-exclamation-circle me-2"></i>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="booking-modal-body">
            <div class="booking-modal-icon <?php echo e($modalType); ?>">
                <!--[if BLOCK]><![endif]--><?php if($modalType === 'success'): ?>
...
<script>
    ...
    document.addEventListener('livewire:init', () => {
        Livewire.on('booking-success', () => {
            setTimeout(() => {
                window.location.href = '<?php echo e(route("tenant.bookings")); ?>';
            }, 2500); // Redirect after 2.5 seconds
        });
    });
</script>
<?php $__env->stopPush(); ?><?php /**PATH D:\final-project-smstr1\resources\views/livewire/public/room-detail.blade.php ENDPATH**/ ?>