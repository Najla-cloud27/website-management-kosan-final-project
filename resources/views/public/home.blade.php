...
@section('title', 'Beranda - Kosan DiriQ by Najla')

@section('content')

<!-- Hero-Section Start -->
<section class="hero-section bg-cover" style="background-image: url({{ asset('travo/img/hero/bg.jpg') }});">
    <div class="shape float-bob-x">
        <img src="{{ asset('travo/img/shape/plane-1.png') }}" alt="">
    </div>
    <div class="container">
            ...
            <div class="row g-4">
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="about-left-image">
                        @if(isset($roomsWithImages[0]) && $roomsWithImages[0]->main_image_url && file_exists(public_path('storage/' . $roomsWithImages[0]->main_image_url)))
                            <img src="{{ Storage::url($roomsWithImages[0]->main_image_url) }}" alt="{{ $roomsWithImages[0]->name }}" class="wow img-custom-anim-left" style="width: 100%; height: 400px; object-fit: cover;">
                        @else
                        ...
                        <div class="about-image-2">
                            @if(isset($roomsWithImages[1]) && $roomsWithImages[1]->main_image_url && file_exists(public_path('storage/' . $roomsWithImages[1]->main_image_url)))
                                <img src="{{ Storage::url($roomsWithImages[1]->main_image_url) }}" alt="{{ $roomsWithImages[1]->name }}" class="wow img-custom-anim-left" style="width: 100%; height: 250px; object-fit: cover;">
                            @else
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="about-right-image">
                        @if(isset($roomsWithImages[2]) && $roomsWithImages[2]->main_image_url && file_exists(public_path('storage/' . $roomsWithImages[2]->main_image_url)))
                            <img src="{{ Storage::url($roomsWithImages[2]->main_image_url) }}" alt="{{ $roomsWithImages[2]->name }}" class="wow img-custom-anim-right" style="width: 100%; height: 400px; object-fit: cover;">
                        @else
                            <div class="placeholder-container-about" style="height: 400px;">
                        ...
                        @endif
                        <div class="about-image-2">
                            @if(isset($roomsWithImages[3]) && $roomsWithImages[3]->main_image_url && file_exists(public_path('storage/' . $roomsWithImages[3]->main_image_url)))
                                <img src="{{ Storage::url($roomsWithImages[3]->main_image_url) }}" alt="{{ $roomsWithImages[3]->name }}" class="wow img-custom-anim-right" style="width: 100%; height: 250px; object-fit: cover;">
                            @else
                                <div class="placeholder-container-about" style="height: 250px;">
...
<section class="service-section section-padding pb-0 section-bg fix">
    <div class="shape float-bob-y">
        <img src="{{ asset('travo/img/shape/plane-2.png') }}" alt="">
    </div>
    <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="service-box-item">
                                    ...
                                    <div class="content">
                                        <h3>
                                            <a href="{{ route('rooms.index') }}">Keamanan 24 Jam</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="swiper-slide">
                                <div class="service-box-item">
                                    ...
                                    <div class="content">
                                        <h3>
                                            <a href="{{ route('rooms.index') }}">Kamar Nyaman</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="swiper-slide">
                                <div class="service-box-item">
                                    ...
                                    <div class="content">
                                        <h3>
                                            <a href="{{ route('rooms.index') }}">Parkir Luas</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="swiper-slide">
                                <div class="service-box-item">
                                    ...
                                    <div class="content">
                                        <h3>
                                            <a href="{{ route('rooms.index') }}">Dapur Bersama</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="swiper-slide">
                                <div class="service-box-item">
                                    ...
                                    <div class="content">
                                        <h3>
                                            <a href="{{ route('rooms.index') }}">Kamar Mandi Dalam</a>
                                        </h3>
                                        <p>
            ...
            @forelse($featuredRooms as $room)
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".{{ $loop->index * 2 }}s">
                    <div class="package-card h-100">
                        @if($room->main_image_url && file_exists(public_path('storage/' . $room->main_image_url)))
                            <img src="{{ Storage::url($room->main_image_url) }}" class="card-img-top" alt="{{ $room->name }}" style="height: 250px; object-fit: cover;">
                        @else
                        ...
                        <div class="package-card-content">
                            <div class="package-card-top">
                                <span class="badge {{ status_badge_class($room->status) }}">
                                    {{ format_status($room->status) }}
                                </span>
                                <h3><a href="{{ route('rooms.show', $room->slug) }}">{{ $room->name }}</a></h3>
                                <p>{{ Str::limit($room->description, 100) }}</p>
                            </div>
                            <div class="package-card-bottom">
                                <div class="price">
                                    <span class="text-primary fw-bold">Rp {{ number_format($room->price, 0, ',', '.') }}</span>
...
<!-- CTA Section -->
<section class="cta-section fix section-padding bg-cover" style="background-image: url({{ asset('travo/img/cta/bg.jpg') }});">
    <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="cta-button text-lg-end wow fadeInUp" data-wow-delay=".5s">
                        <a href="{{ route('rooms.index') }}" class="theme-btn style-3">
