    ...
    <div class="scrollbar" data-simplebar="">
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a class="side-nav-link {{ request()->routeIs('tenant.dashboard') ? 'active' : '' }}" 
            ...
            <!-- Booking Saya -->
            <li class="side-nav-item">
                <a class="side-nav-link {{ request()->routeIs('tenant.bookings') ? 'active' : '' }}" 
                   href="{{ route('tenant.bookings') }}">
            ...
            <!-- Riwayat Tagihan -->
            <li class="side-nav-item">
                <a class="side-nav-link {{ request()->routeIs('tenant.billing.*') ? 'active' : '' }}" 
                   href="{{ route('tenant.billing.history') }}">
            ...
            <!-- Keluhan -->
            <li class="side-nav-item">
                <a class="side-nav-link {{ request()->routeIs('tenant.complaints.index') ? 'active' : '' }}" 
                   href="{{ route('tenant.complaints.index') }}">
            ...
            <!-- Buat Keluhan -->
            <li class="side-nav-item">
                <a class="side-nav-link {{ request()->routeIs('tenant.complaints.create') ? 'active' : '' }}" 
                   href="{{ route('tenant.complaints.create') }}">
