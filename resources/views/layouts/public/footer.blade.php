    ...
    <div class="container">
        <div class="footer-top style-new">
            <div class="logo-items">
                <a href="{{ route('home') }}">
                    <img src="{{ asset('travo/img/kosan-diriq.png') }}" alt="Kosan DiriQ Logo" style="max-height: 50px; filter: brightness(0) invert(1);">
                </a>
            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 ps-lg-5 wow fadeInUp" data-wow-delay=".4s">
                    <div class="single-widget-items">
                        ...
                        <ul class="list-items style-3">
                            ...
                            <li><a href="{{ route('rooms.index') }}">Kamar Tersedia</a></li>
                        ...
                        <ul class="list-items style-3">
                            ...
                            @auth
                                @if(auth()->user()->role === 'penyewa')
                                    ...
                                    <li><a href="{{ route('tenant.billing.history') }}">Tagihan</a></li>
                                    <li><a href="{{ route('tenant.complaints.index') }}">Keluhan</a></li>
        ...
        <div class="footer-bottom style-2">
            <div class="footer-wrapper">
                <p class="wow fadeInUp" data-wow-delay=".3s">
                    ©<span class="style-3">Kosan DiriQ by Najla</span> {{ date('Y') }}. All Rights Reserved
                </p>
